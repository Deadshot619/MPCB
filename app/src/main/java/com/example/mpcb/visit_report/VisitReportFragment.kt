...
//                1 -> if (true) mBinding.ivIndustryTag.visibility = View.VISIBLE
                1 -> if (getReportFlagStatus(Constants.REPORT_1)) mBinding.ivIndustryTag.visibility = View.VISIBLE
                2 -> if (getReportFlagStatus(Constants.REPORT_2)) mBinding.ivProductTag.visibility = View.VISIBLE
                3 -> if (getReportFlagStatus(Constants.REPORT_3)) mBinding.ivTreatmentTag.visibility = View.VISIBLE
                4 -> if (getReportFlagStatus(Constants.REPORT_4)) mBinding.ivWaterWasteTag.visibility = View.VISIBLE
                5 -> if (getReportFlagStatus(Constants.REPORT_5)) mBinding.ivDisposalTag.visibility = View.VISIBLE
                6 -> if (getReportFlagStatus(Constants.REPORT_6)) mBinding.ivOmsWaterTag.visibility = View.VISIBLE
                7 -> if (getReportFlagStatus(Constants.REPORT_7)) mBinding.ivElectricTag.visibility = View.VISIBLE
                8 -> if (getReportFlagStatus(Constants.REPORT_8)) mBinding.ivLastJVSTag.visibility = View.VISIBLE
                9 -> if (getReportFlagStatus(Constants.REPORT_9)) mBinding.ivAirPollutionTag.visibility = View.VISIBLE
                10 -> if (getReportFlagStatus(Constants.REPORT_10)) mBinding.ivOmsStackTag.visibility = View.VISIBLE
                11 -> if (getReportFlagStatus(Constants.REPORT_11)) mBinding.ivOmsAmbientTag.visibility = View.VISIBLE
                12 -> if (getReportFlagStatus(Constants.REPORT_12)) mBinding.ivHazardoudTag.visibility = View.VISIBLE
                13 -> if (getReportFlagStatus(Constants.REPORT_13)) mBinding.ivNonHazardousTag.visibility = View.VISIBLE
                14 -> if (getReportFlagStatus(Constants.REPORT_14)) mBinding.ivTreeTag.visibility = View.VISIBLE
                15 -> if (getReportFlagStatus(Constants.REPORT_15)) mBinding.ivStatutoryTag.visibility = View.VISIBLE
                16 -> if (getReportFlagStatus(Constants.REPORT_16)) mBinding.ivPreviousTag.visibility = View.VISIBLE
                17 -> if (getReportFlagStatus(Constants.REPORT_17)) mBinding.ivBankGuaranteeTag.visibility = View.VISIBLE
                18 -> if (getReportFlagStatus(Constants.REPORT_18)) mBinding.ivAdditionalTag.visibility = View.VISIBLE
            }
        }
    }
